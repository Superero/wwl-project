    ...
    <div class="index-list">
      <div class="index-row reveal">
        ...
        <div>
          ...
          <h3>Learning design Strategy</h3>
        </div>
  ...
  <div class="wrap">
    ...
    <div class="solutions-grid">
      ...
      <div class="solution-card reveal reveal-delay-2">
        ...
        <h3>Management & Human Performance</h3>
  ...
  <div class="wrap">
    ...
    <div class="insights-grid">
      <article class="insight-card reveal">
        <div class="insight-thumb"><span class="insight-cat">Learning Impact</span></div>
        <div class="insight-body">
          <span class="insight-meta">12 min · 3 sept. 2026</span>
          <h3>Votre formation a eu 95 % de satisfaction. Et alors ?</h3>
          <a href="#insights" class="insight-link">Lire l'article →</a>
        </div>
      </article>
      <article class="insight-card reveal reveal-delay-1">
        <div class="insight-thumb"><span class="insight-cat">Learning Experience</span></div>
        <div class="insight-body">
      ...
      <article class="insight-card reveal reveal-delay-2">
        <div class="insight-thumb"><span class="insight-cat">Digital Learning & IA</span></div>
        <div class="insight-body">
...
<section id="apropos">
  <div class="wrap about-wrap">
    <div class="reveal">
      ...
      <div class="btn-row">
        <a href="#contact" class="btn-primary">Parler de votre enjeu Learning</a>
      </div>
    </div>
    <div class="about-panel reveal reveal-delay-2">
      <div class="row"><span>Exigence</span><span class="v">Concevoir avec rigueur</span></div>
      <div class="row"><span>Expérience</span><span class="v">Penser pour l'apprenant et son contexte réel</span></div>
      <div class="row"><span>Impact</span><span class="v">Mesurer ce qui change vraiment</span></div>
