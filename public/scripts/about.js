  /* =========================================================
   ...
   (identique à la homepage et à la page Solutions)
   ========================================================= */
...
(function(){
  ...
  (function(){
    ...
    const hoverTargets = 'a, button, .adn-card, .team-card, .about-panel .row, .cert-badge, .nav-cta, .wa-fab, .success-modal-button';
